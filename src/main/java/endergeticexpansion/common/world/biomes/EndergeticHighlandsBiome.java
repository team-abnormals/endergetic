...
public class EndergeticHighlandsBiome extends EndergeticBiome {
	...
	public void addSpawnsAndFeatures() {
		this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, EEFeatures.ENDERGETIC_GATEWAY.withConfiguration(EndGatewayConfig.func_214702_a(EndDimension.SPAWN, true)).withPlacement(Placement.END_GATEWAY.configure(IPlacementConfig.NO_PLACEMENT_CONFIG)));
