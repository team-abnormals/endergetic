...
public class BiomePoiseForest extends Biome {
	...
	public BiomePoiseForest() {
		...
		this.addFeature(Decoration.SURFACE_STRUCTURES, createDecoratedFeature(EEFeatures.POISE_DOME, IFeatureConfig.NO_FEATURE_CONFIG, Placement.NOISE_HEIGHTMAP_32, new NoiseDependant(-0.1D, 1, 1)));
