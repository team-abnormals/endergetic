...
public class EEItems {
	...
	public static final RegistryObject<Item> BOLLOOM_BALLOON_GREEN      = RegistryUtils.createItem("bolloom_balloon_green", () -> new ItemBolloomBalloon(RegistryUtils.createSimpleItemProperty(16, ItemGroup.TOOLS), DyeColor.GREEN));
	public static final RegistryObject<Item> BOLLOOM_BALLOON_LIGHT_BLUE = RegistryUtils.createItem("bolloom_balloon_light_blue", () -> new ItemBolloomBalloon(RegistryUtils.createSimpleItemProperty(16, ItemGroup.TOOLS), DyeColor.LIGHT_BLUE));
	public static final RegistryObject<Item> BOLLOOM_BALLOON_CYAN       = RegistryUtils.createItem("bolloom_balloon_cyan", () -> new ItemBolloomBalloon(RegistryUtils.createSimpleItemProperty(16, ItemGroup.TOOLS), DyeColor.CYAN));
	public static final RegistryObject<Item> BOLLOOM_BALLOON_BLUE       = RegistryUtils.createItem("bolloom_balloon_blue", () -> new ItemBolloomBalloon(RegistryUtils.createSimpleItemProperty(16, ItemGroup.TOOLS), DyeColor.BLUE));
	public static final RegistryObject<Item> BOLLOOM_BALLOON_PINK       = RegistryUtils.createItem("bolloom_balloon_pink", () -> new ItemBolloomBalloon(RegistryUtils.createSimpleItemProperty(16, ItemGroup.TOOLS), DyeColor.PINK));
	public static final RegistryObject<Item> BOLLOOM_BALLOON_MAGENTA    = RegistryUtils.createItem("bolloom_balloon_magenta", () -> new ItemBolloomBalloon(RegistryUtils.createSimpleItemProperty(16, ItemGroup.TOOLS), DyeColor.MAGENTA));
	public static final RegistryObject<Item> BOLLOOM_BALLOON_PURPLE     = RegistryUtils.createItem("bolloom_balloon_purple", () -> new ItemBolloomBalloon(RegistryUtils.createSimpleItemProperty(16, ItemGroup.TOOLS), DyeColor.PURPLE));
	public static final RegistryObject<Item> BOLLOOM_BALLOON_BROWN      = RegistryUtils.createItem("bolloom_balloon_brown", () -> new ItemBolloomBalloon(RegistryUtils.createSimpleItemProperty(16, ItemGroup.TOOLS), DyeColor.BROWN));
	public static final RegistryObject<Item> BOLLOOM_BALLOON_GRAY       = RegistryUtils.createItem("bolloom_balloon_gray", () -> new ItemBolloomBalloon(RegistryUtils.createSimpleItemProperty(16, ItemGroup.TOOLS), DyeColor.GRAY));
	...
	public static final RegistryObject<Item> BOOFLO_VEST                = RegistryUtils.createItem("booflo_vest", () -> new ItemBoofloVest(new Item.Properties().group(ItemGroup.COMBAT)));
