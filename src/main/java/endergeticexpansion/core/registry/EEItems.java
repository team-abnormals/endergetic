...
public class EEItems {
	...
	public static void onRegisterItems(RegistryEvent.Register<Item> event) {
		...
		final Item[] items = {
			BOLLOOM_FRUIT, BOOFLO_HIDE, BOLLOOM_BALLOON, BOLLOOM_BALLOON_RED, BOLLOOM_BALLOON_ORANGE, BOLLOOM_BALLOON_YELLOW, BOLLOOM_BALLOON_LIME, BOLLOOM_BALLOON_GREEN, BOLLOOM_BALLOON_LIGHT_BLUE, BOLLOOM_BALLOON_CYAN, 
