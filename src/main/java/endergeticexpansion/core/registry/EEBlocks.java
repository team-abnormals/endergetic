...
public class EEBlocks {
	...
	public static void onRegisterBlocks(RegistryEvent.Register<Block> event) {
		final Block blocks[] = {
			...
			BOLLOOM_BUD, PUFFBUG_HIVE, HIVE_HANGER, BOLLOOM_PARTICLE, BOOF_BLOCK, BOOF_DISPENSED_BLOCK, EUMUS_BRICK_SLAB, EUMUS_BRICKS_CHISELED, EUMUS_BRICK_SLAB, EUMUS_BRICK_STAIRS
		};
