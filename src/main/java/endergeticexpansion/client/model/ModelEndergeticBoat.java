...
@OnlyIn(Dist.CLIENT)
public class ModelEndergeticBoat extends SegmentedModel<EntityEndergeticBoat> {
	...
	public void setRotationAngles(EntityEndergeticBoat entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
