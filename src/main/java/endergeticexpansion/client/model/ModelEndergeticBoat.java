...
@OnlyIn(Dist.CLIENT)
public class ModelEndergeticBoat extends EntityModel<EntityEndergeticBoat> {
    ...
    public void render(EntityEndergeticBoat entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    protected void renderPaddle(EntityEndergeticBoat boat, int paddle, float scale, float limbSwing) {
