...
@OnlyIn(Dist.CLIENT)
public class ParticlePoiseBubble extends SpriteTexturedParticle {
	protected final IAnimatedSprite animatedSprite;
	private float angle;
	
	public ParticlePoiseBubble(IAnimatedSprite animatedSprite, World world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ, boolean isShort) {
	...
	public static class Factory implements IParticleFactory<BasicParticleType> {
		...
		public Particle makeParticle(BasicParticleType type, World world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			return new ParticlePoiseBubble(this.animatedSprite, world, x, y, z, xSpeed, ySpeed, zSpeed, false);
		}
	}
	...
	public static class ShortFactory implements IParticleFactory<BasicParticleType> {
		...
		@Override
		public Particle makeParticle(BasicParticleType type, World world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			return new ParticlePoiseBubble(this.animatedSprite, world, x, y, z, xSpeed, ySpeed, zSpeed, true);
		}
	}
}