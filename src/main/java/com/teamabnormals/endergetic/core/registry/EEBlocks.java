...
public final class EEBlocks {
	...
	public static final RegistryObject<Block> CORROCK_OVERWORLD = HELPER.createBlock("overworld_corrock", () -> new CorrockPlantBlock(EEProperties.getCorrockBase(MaterialColor.TERRACOTTA_BROWN, false), false), (CreativeModeTab) null);
	public static final RegistryObject<Block> CORROCK_NETHER = HELPER.createBlock("nether_corrock", () -> new CorrockPlantBlock(EEProperties.getCorrockBase(MaterialColor.TERRACOTTA_RED, false), false), (CreativeModeTab) null);
	public static final RegistryObject<Block> CORROCK_END = HELPER.createBlock("end_corrock", () -> new CorrockPlantBlock(EEProperties.getCorrockBase(MaterialColor.TERRACOTTA_PURPLE, false), false), (CreativeModeTab) null);
	public static final RegistryObject<Block> SPECKLED_OVERWORLD_CORROCK = HELPER.createBlock("speckled_overworld_corrock", () -> new SpeckledCorrockBlock(Properties.copy(Blocks.END_STONE)), (CreativeModeTab) null);
	public static final RegistryObject<Block> SPECKLED_NETHER_CORROCK = HELPER.createBlock("speckled_nether_corrock", () -> new SpeckledCorrockBlock(Properties.copy(Blocks.END_STONE)), (CreativeModeTab) null);
	public static final RegistryObject<Block> SPECKLED_END_CORROCK = HELPER.createBlock("speckled_end_corrock", () -> new SpeckledCorrockBlock(Properties.copy(Blocks.END_STONE)), (CreativeModeTab) null);
	public static final RegistryObject<Block> CORROCK_OVERWORLD_BLOCK = HELPER.createBlock("overworld_corrock_block", () -> new CorrockBlock(EEProperties.getCorrockBase(MaterialColor.TERRACOTTA_BROWN, true), SPECKLED_OVERWORLD_CORROCK, CORROCK_OVERWORLD), (CreativeModeTab) null);
	public static final RegistryObject<Block> CORROCK_NETHER_BLOCK = HELPER.createBlock("nether_corrock_block", () -> new CorrockBlock(EEProperties.getCorrockBase(MaterialColor.TERRACOTTA_RED, true), SPECKLED_NETHER_CORROCK, CORROCK_NETHER), (CreativeModeTab) null);
	public static final RegistryObject<Block> CORROCK_END_BLOCK = HELPER.createBlock("end_corrock_block", () -> new CorrockBlock(EEProperties.getCorrockBase(MaterialColor.TERRACOTTA_PURPLE, true), SPECKLED_END_CORROCK, CORROCK_END), (CreativeModeTab) null);
	...
	public static final RegistryObject<Block> INFESTED_CORROCK = HELPER.createBlock("infested_corrock", () -> new InfestedCorrockBlock(EEProperties.INFESTED_CORROCK), (CreativeModeTab) null);
	...
	public static final RegistryObject<Block> EETLE_EGG = HELPER.createBlock("eetle_egg", () -> new EetleEggBlock(EEProperties.EETLE_EGG), (CreativeModeTab) null);
