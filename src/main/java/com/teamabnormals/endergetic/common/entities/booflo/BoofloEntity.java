package com.teamabnormals.endergetic.common.entities.booflo;
...
import com.teamabnormals.endergetic.common.entities.bolloom.BolloomFruitEntity;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloAttackGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloBoofGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloBreedGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloEatFruitGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloEatPuffBugGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloFaceRandomGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloGiveBirthGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloGroundHopGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloHuntFruitGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloHuntPuffBugGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloNearestAttackableTargetGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloSinkGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloSlamGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloSwimGoal;
import com.teamabnormals.endergetic.common.entities.booflo.ai.BoofloTemptGoal;
...
public class BoofloEntity extends PathfinderMob implements Endimatable {
	...
	public void aiStep() {
		...
		if (this.hasAggressiveAttackTarget()) {
			...
			if (!this.level.isClientSide && (this.distanceToSqr(attackTarget) > 1152.0D || attackTarget.isInvisible() || (attackTarget instanceof PuffBugEntity && attackTarget.isPassenger()))) {
	...
	public void boof(float internalStrength, float offensiveStrength, boolean slam) {
		...
		if (slam) {
			for (int i = 0; i < 12; i++) {
				...
				if (this.level.isClientSide) {
					this.level.addParticle(EEParticles.POISE_BUBBLE.get(), x, y, z, TemporaryMathUtil.makeNegativeRandomly((this.random.nextFloat() * 0.3F), this.random) + 0.025F, (this.random.nextFloat() * 0.15F) + 0.1F, TemporaryMathUtil.makeNegativeRandomly((this.random.nextFloat() * 0.3F), this.random) + 0.025F);
				}
			}
		}
	...
	public boolean hurt(DamageSource source, float amount) {
		...
		if (super.hurt(source, source.getEntity() instanceof PuffBugEntity ? 2.5F : newCalculatedDamage)) {
	...
	static class FlyingLookController extends LookControl {
		...
		public void tick() {
			...
			if (((BoofloEntity) this.mob).isEndimationPlaying(EEPlayableEndimations.BOOFLO_CHARGE)) {
