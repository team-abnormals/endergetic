...
import com.teamabnormals.endergetic.common.entities.eetle.flying.FlyingRotations;
...
public class BroodEetleModel extends EndimatorEntityModel<BroodEetleEntity> {
	...
	public static LayerDefinition createLayerDefinition() {
		...
		EndimatorPartDefinition egg = body.addOrReplaceChild("egg", CubeListBuilder.create().texOffs(61, 0).addBox(0.0F, -10.0F, 0.0F, 26.0F, 20.0F, 17.0F, false), PartPose.offsetAndRotation(-13.0F, 6.0F, 24.0F, 0.40142572F, 0.0F, 0.0F));
		...
		EndimatorPartDefinition eggLayer = egg.addOrReplaceChild("eggLayer", CubeListBuilder.create().texOffs(210, 56).addBox(0.0F, 0.0F, 0.0F, 27.0F, 21.0F, 18.0F, false), PartPose.offsetAndRotation(-0.5F, -10.5F, -0.5F, 0.0F, 0.0F, 0.0F));
		EndimatorPartDefinition eggSack = egg.addOrReplaceChild("eggSack", CubeListBuilder.create().texOffs(5, 27).addBox(-8.0F, -8.0F, 0.0F, 16.0F, 16.0F, 11.0F, false), PartPose.offsetAndRotation(13.0F, 0.0F, 17.0F, 0.0F, 0.0F, 0.0F));
		EndimatorPartDefinition eggMouthTop = eggSack.addOrReplaceChild("eggMouthTop", CubeListBuilder.create().texOffs(125, 60).addBox(0.0F, 0.0F, 0.0F, 21.0F, 21.0F, 17.0F, false), PartPose.offsetAndRotation(11.0F, -10.5F, 0.5F, 0.0F, 0.0F, 1.5707964F));
		EndimatorPartDefinition eggMouthBottom = eggSack.addOrReplaceChild("eggMouthBottom", CubeListBuilder.create().texOffs(125, 60).addBox(0.0F, 0.0F, 0.0F, 21.0F, 21.0F, 17.0F, false), PartPose.offsetAndRotation(-11.0F, 10.5F, 0.5F, 0.0F, 0.0F, 4.712389F));
		EndimatorPartDefinition eggMouthLeft = eggSack.addOrReplaceChild("eggMouthLeft", CubeListBuilder.create().texOffs(125, 60).addBox(0.0F, 0.0F, 0.0F, 21.0F, 21.0F, 17.0F, false), PartPose.offsetAndRotation(11.0F, 10.5F, 0.5F, 0.0F, 0.0F, 3.1415927F));
		EndimatorPartDefinition eggMouthRight = eggSack.addOrReplaceChild("eggMouthRight", CubeListBuilder.create().texOffs(125, 60).addBox(0.0F, 0.0F, 0.0F, 21.0F, 21.0F, 17.0F, false), PartPose.offsetAndRotation(-11.0F, -10.5F, 0.5F, 0.0F, 0.0061086523F, 0.0F));
