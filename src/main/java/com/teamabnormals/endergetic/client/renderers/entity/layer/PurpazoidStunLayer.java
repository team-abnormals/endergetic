...
public class PurpazoidStunLayer extends RenderLayer<PurpoidEntity, PurpoidModel> {
	...
	public PurpazoidStunLayer(RenderLayerParent<PurpoidEntity, PurpoidModel> parent, PurpoidModel purpModel, PurpoidGelModel gelModel) {
		super(parent);
	...
	@Override
	public void render(PoseStack stack, MultiBufferSource bufferSource, int packedLightIn, PurpoidEntity purpoid, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
