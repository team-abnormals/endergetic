...
public final class EEProperties {
	...
	public static final AbstractBlock.Properties EETLE_EGG = AbstractBlock.Properties.of(Material.CORAL, MaterialColor.COLOR_PURPLE).lightLevel(state -> 7 + state.getValue(EetleEggBlock.SIZE)).noDrops().requiresCorrectToolForDrops().strength(1.0F).sound(EESounds.EESoundTypes.EETLE_EGG);
	public static final AbstractBlock.Properties INFESTED_CORROCK = AbstractBlock.Properties.of(Material.CORAL, MaterialColor.COLOR_PURPLE).lightLevel(state -> 12).randomTicks().strength(1.5F, 6.0F).sound(SoundType.CORAL_BLOCK);
	public static final AbstractBlock.Properties PETRIFIED_INFESTED_CORROCK = AbstractBlock.Properties.of(Material.CORAL, MaterialColor.COLOR_PURPLE).lightLevel(state -> 12).strength(1.5F, 6.0F).sound(SoundType.CORAL_BLOCK);
	...
	public static AbstractBlock.Properties getGlowingCorrockBase(MaterialColor color) {
		return AbstractBlock.Properties.of(Material.WATER_PLANT, color).lightLevel((state) -> 12).strength(0F).noCollission();
	}
