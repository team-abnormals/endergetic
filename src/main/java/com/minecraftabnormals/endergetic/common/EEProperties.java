...
public final class EEProperties {
	...
	public static final AbstractBlock.Properties EETLE_EGGS = AbstractBlock.Properties.create(Material.CORAL, MaterialColor.PURPLE).noDrops().setRequiresTool().hardnessAndResistance(1.0F).sound(SoundType.WET_GRASS);
