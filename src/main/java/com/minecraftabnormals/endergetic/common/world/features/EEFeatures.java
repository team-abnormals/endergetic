...
public final class EEFeatures {
	...
	public static final RegistryObject<Feature<SphereReplaceConfig>> CORROCK_GROUND_PATCH = createFeature("corrock_ground_patch", () -> new CorrockGroundPatchFeature(SphereReplaceConfig.CODEC));
	...
	public static final class Configured {
		...
		public static final ConfiguredFeature<?, ?> CORROCK_PATCH = EEFeatures.CORROCK_PATCH.get().configured(new EndergeticPatchConfig(0.175F, false)).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).count(6);
		public static final ConfiguredFeature<?, ?> CORROCK_GROUND_PATCH = EEFeatures.CORROCK_GROUND_PATCH.get().configured(new SphereReplaceConfig(EEBlocks.CORROCK_END_BLOCK.get().defaultBlockState(), FeatureSpread.fixed(3), 3, Lists.newArrayList(Blocks.END_STONE.defaultBlockState())));
		...
		public static final ConfiguredFeature<?, ?> CORROCK_BRANCH = EEFeatures.CORROCK_BRANCH.get().configured(new CorrockBranchConfig(ImmutableList.of(EEBlocks.CORROCK_END_BLOCK.get().defaultBlockState(), EEBlocks.EUMUS.get().defaultBlockState()), 0.5F, 0.4F)).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).count(64);
		...
		public static final ConfiguredFeature<?, ?> MEDIUM_CORROCK_TOWER = EEFeatures.MEDIUM_CORROCK_TOWER.get().configured(new CorrockTowerConfig(3, 4, 0.7F, 0.075F)).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).count(2);
		public static final ConfiguredFeature<?, ?> LARGE_CORROCK_TOWER = EEFeatures.LARGE_CORROCK_TOWER.get().configured(new CorrockTowerConfig(2, 5, 0.9F, 0.1F)).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).count(2);
		public static final ConfiguredFeature<?, ?> CORROCK_TOWER = EEFeatures.WEIGHTED_FEATURES.get().configured(WeightedFeatureConfig.createFromPairs(Pair.of(SMALL_CORROCK_TOWER, 6), Pair.of(MEDIUM_CORROCK_TOWER, 12), Pair.of(LARGE_CORROCK_TOWER, 4))).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).count(FeatureSpread.of(128, 128));
		public static final ConfiguredFeature<?, ?> CORROCK_SHELF = EEFeatures.CORROCK_SHELF.get().configured(new ProbabilityConfig(0.75F)).decorated(EEPlacements.HEIGHTMAP_SPREAD_LOWER.get().configured(IPlacementConfig.NONE).squared()).count(8);
		public static final ConfiguredFeature<?, ?> CORROCK_ARCH = EEFeatures.CORROCK_ARCH.get().configured(new CorrockArchConfig(0.1F, 0.25F, 13.0F, 22.0F, 7.0F)).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).count(26);
		public static final ConfiguredFeature<?, ?> EETLE_EGG = EEFeatures.EETLE_EGG.get().configured(new EndergeticPatchConfig(0.75F, false)).decorated(Placement.NOPE.configured(IPlacementConfig.NONE)).count(1);
		public static final ConfiguredFeature<?, ?> EUMUS_PATCH = EEFeatures.EUMUS_PATCH.get().configured(new MultiPatchConfig(2, 3)).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).count(2);
		public static final ConfiguredFeature<?, ?> SPECKLED_CORROCK_PATCH = EEFeatures.SPECKLED_CORROCK_PATCH.get().configured(new MultiPatchConfig(2, 3)).decorated(Features.Placements.HEIGHTMAP_DOUBLE_SQUARE).decorated(Placement.CHANCE.configured(new ChanceConfig(2)));
