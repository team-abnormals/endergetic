...
public final class EEFeatures {
	...
	public static final class Configured {
		...
		public static final ConfiguredFeature<?, ?> CORROCK_PATCH = EEFeatures.CORROCK_PATCH.get().withConfiguration(new ProbabilityConfig(0.2F)).withPlacement(Features.Placements.PATCH_PLACEMENT).func_242731_b(7);
		...
		public static final ConfiguredFeature<?, ?> LARGE_CORROCK_TOWER = EEFeatures.LARGE_CORROCK_TOWER.get().withConfiguration(new CorrockTowerConfig(2, 5, 0.5F, 0.1F)).withPlacement(Features.Placements.PATCH_PLACEMENT).func_242731_b(2);
		...
		public static final ConfiguredFeature<?, ?> CORROCK_ARCH = EEFeatures.CORROCK_ARCH.get().withConfiguration(new CorrockArchConfig(0.1F, 0.25F, 13.0F, 22.0F, 7.0F)).withPlacement(Features.Placements.PATCH_PLACEMENT).func_242731_b(24);
