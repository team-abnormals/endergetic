...
public final class EEBlocks {
	...
	public static final RegistryObject<Block> SPECKLED_OVERWORLD_CORROCK        = HELPER.createBlock("speckled_overworld_corrock", () -> new SpeckledCorrockBlock(Properties.copy(Blocks.END_STONE)), ItemGroup.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> SPECKLED_NETHER_CORROCK           = HELPER.createBlock("speckled_nether_corrock", () -> new SpeckledCorrockBlock(Properties.copy(Blocks.END_STONE)), ItemGroup.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> SPECKLED_END_CORROCK              = HELPER.createBlock("speckled_end_corrock", () -> new SpeckledCorrockBlock(Properties.copy(Blocks.END_STONE)), ItemGroup.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> CORROCK_OVERWORLD_BLOCK           = HELPER.createBlock("overworld_corrock_block", () -> new CorrockBlock(EEProperties.getCorrockBase(MaterialColor.TERRACOTTA_BROWN, true), SPECKLED_OVERWORLD_CORROCK, CORROCK_OVERWORLD, false), ItemGroup.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> CORROCK_NETHER_BLOCK              = HELPER.createBlock("nether_corrock_block", () -> new CorrockBlock(EEProperties.getCorrockBase(MaterialColor.TERRACOTTA_RED, true), SPECKLED_NETHER_CORROCK, CORROCK_NETHER, false), ItemGroup.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> CORROCK_END_BLOCK                 = HELPER.createBlock("end_corrock_block", () -> new CorrockBlock(EEProperties.getCorrockBase(MaterialColor.TERRACOTTA_PURPLE, true), SPECKLED_END_CORROCK, CORROCK_END, false), ItemGroup.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> INFESTED_CORROCK                                       = HELPER.createBlock("infested_corrock", () -> new InfestedCorrockBlock(EEProperties.INFESTED_CORROCK), ItemGroup.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> BOLLOOM_BUD           = HELPER.createBlockWithISTER("bolloom_bud", () -> new BolloomBudBlock(EEProperties.getPoiseWood(true, false)), () -> bolloomBudISTER(), ItemGroup.TAB_DECORATIONS);
	public static final RegistryObject<Block> PUFFBUG_HIVE          = HELPER.createBlockWithISTER("puffbug_hive", () -> new PuffBugHiveBlock(EEProperties.getPuffBugHive(true)), () -> puffbugHiveISTER(), ItemGroup.TAB_DECORATIONS);
