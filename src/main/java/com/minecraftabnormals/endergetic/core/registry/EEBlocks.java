...
public final class EEBlocks {
	...
	public static final RegistryObject<Block> POISMOSS              = HELPER.createBlock("poismoss", () -> new PoismossBlock(EEProperties.POISE_GRASS(false)), ItemGroup.BUILDING_BLOCKS);
