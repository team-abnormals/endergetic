 ...
 */
public class SmallEetleEggsModel implements IEetleEggsModel {
	...
	public SmallEetleEggsModel() {
		...
		this.bigEgg.setRotationPoint(1.5F, 24.0F, -1.5F);
		...
		this.otherEgg.setRotationPoint(-4.0F, 24.0F, 2.0F);
