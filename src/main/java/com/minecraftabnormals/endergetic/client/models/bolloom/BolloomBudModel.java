...
public class BolloomBudModel {
	...
	public BolloomBudModel() {
		...
		this.Pedal = new ModelPart(textureSize[0], textureSize[1], 0, 18);
		...
		this.Pedal_3 = new ModelPart(textureSize[0], textureSize[1], 0, 18);
		...
		this.Pedal_1 = new ModelPart(textureSize[0], textureSize[1], 0, 18);
		...
		this.Pedal_2 = new ModelPart(textureSize[0], textureSize[1], 0, 18);
		...
		this.Center = new ModelPart(textureSize[0], textureSize[1], 0, 0);
		this.Center.setPos(-7.0F, 21.0F, -7.0F);
		this.Center.addBox(0.0F, 0.0F, 0.0F, 14, 3, 14, 0.0F);
		this.Pedal_open = new ModelPart(textureSize[0], textureSize[1], 0, 18);
		...
		this.Pedal_3_open = new ModelPart(textureSize[0], textureSize[1], 0, 18);
		...
		this.Pedal_1_open = new ModelPart(textureSize[0], textureSize[1], 0, 18);
		...
		this.Pedal_2_open = new ModelPart(textureSize[0], textureSize[1], 0, 18);
