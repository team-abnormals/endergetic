...
public class MediumEetleEggModel implements IEetleEggModel {
	...
	public static LayerDefinition createLayerDefinition() {
		...
		PartDefinition smallEgg1 = root.addOrReplaceChild("smallEgg1", CubeListBuilder.create(), PartPose.offsetAndRotation(4.0F, 24.0F, 4.0F, 0.0F, 0.0F, 0.0F));
		PartDefinition smallEgg2 = root.addOrReplaceChild("smallEgg2", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.5F, 24.0F, 3.5F, 0.0F, 0.0F, 0.0F));
		PartDefinition BigEgg = root.addOrReplaceChild("BigEgg", CubeListBuilder.create(), PartPose.offsetAndRotation(1.0F, 24.0F, 0.0F, 0.0F, 0.0F, 0.0F));
		PartDefinition Egg = root.addOrReplaceChild("Egg", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.0F, 24.0F, -4.0F, 0.0F, 0.0F, 0.0F));
